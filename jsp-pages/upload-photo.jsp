...
<%
    ...
    try{
        ...
        String uploadFolderPath = path + File.separator +"tomcat"+ File.separator + "webapps" + File.separator + "pmt-pass" + File.separator + "uploaded-docs" + File.separator;
...
<%!
    public static void changeFileName(String fileName, String path, String applicationNo, JspWriter out) throws Exception{
        try{
            ...
            String newFileName = applicationNo + "-PHOTO." + extension;
